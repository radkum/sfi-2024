...
impl SigSetSerializer {
    ...
    pub fn serialize_bedet_set(&self, set_name: &str) -> Result<usize, SigSetError> {
        self.serialize(set_name, BedetSet::SET_MAGIC_U32)
    }

    fn serialize(&self, set_name: &str, magic: u32) -> Result<usize, SigSetError> {
